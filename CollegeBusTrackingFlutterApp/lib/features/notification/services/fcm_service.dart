...
class FCMService {
  ...
  Stream<RemoteMessage> get tapStream => _tapController.stream;
  ...
  Future<void> _initLocalNotifications() async {
    ...
    await _localNotifications.initialize(
      ...
      onDidReceiveNotificationResponse: (details) {
        ...
        // Note: For local notification taps, we might need a separate stream
        // if we want to extract the RemoteMessage back.
        // But FCM onMessageOpenedApp handles background/terminated FCM taps.
      },
    );
