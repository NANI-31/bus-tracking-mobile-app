                      ...
                      _buildProfileCard(
                        ...
                        children: [
                          ...
                          StreamBuilder<List<RouteModel>>(
                            stream: firestoreService.getRoutesByCollege(
                              user.collegeId,
                            ),
                            builder: (context, snapshot) {
                              ...
                              print('DEBUG: allStops: $allStops');
                              print(
                                'DEBUG: user.preferredStop: ${user.preferredStop}',
                              );
                          ...
                          Consumer<ThemeService>(
                            builder: (context, themeService, _) {
                              return SwitchListTile(
                                ...
                                onChanged: (value) {
                                  if (value) {
                                    // Switching TO Bottom Nav
                                    // Force reset to Dashboard root to ensure Bottom Bar is visible
